        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title d-flex align-items-center gap-2">
                    <i class="bx bx-category text-primary fs-4"></i>Detalle del tipo de aplicación
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label class="form-label fw-semibold">
                        <i class="bx bx-rename me-1 text-primary"></i>Nombre de la aplicación
                    </label>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" value="{{ $type->creator->full_name ?? 'N/A' }}" disabled>
                </div>
                <div class="col-md-12 mb-3">
                    <label class="form-label fw-semibold">
                        <i class="bx bx-calendar-plus me-1 text-primary"></i> Fecha de creación
                    </label>
                    <input type="text" class="form-control" value="{{ $type->created_at ? $type->created_at->format('d/m/Y h:i A') : 'N/A' }}" disabled>
                </div>
            </div>
