        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title d-flex align-items-center gap-2">
                    <i class="bx bx-layer text-primary"></i>Crear tipo de aplicación
                </h5>
            ...
            <form action="{{ route('type-applications.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name_application" class="form-control" placeholder="Ej: Sistema de Inventario" maxlength="100" required>
                        <small class="text-muted">Máximo 100 caracteres</small>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-label-secondary" data-bs-dismiss="modal">Cancelar</button>
                    <button type="submit" class="btn btn-primary"><i class="bx bx-save me-1"></i> Crear </button>
                </div>
            </form>
        </div>
    </div>
