@forelse ($typeApplications as $type)
        ...
        <td class="text-end">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#showTypeApplicationModal{{ $type->id }}"><i class="bx bx-show me-1"></i> Ver</a>
                    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editTypeApplicationModal{{ $type->id }}"><i class="bx bx-edit-alt me-1"></i> Editar</a>
    ...
    @empty
    <tr>
        <td colspan="4" class="text-center text-muted"> No se encontraron aplicaciones del tipo</td>
    </tr>
@endforelse
