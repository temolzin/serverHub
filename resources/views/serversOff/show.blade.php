      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" value="{{ $server->environment ?? 'N/A' }}" disabled>
          </div>
          <div class="col-md-6 mb-3">
            <label class="form-label fw-semibold d-block text-start">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" value="{{ $server->hostname_internal ?? 'N/A' }}" disabled>
          </div>
          <div class="col-md-6 mb-3">
            <label class="form-label fw-semibold d-block text-start">
            ...
            <input type="text" class="form-control" value="{{ $server->ip_user ?? 'N/A' }}" disabled>
          </div>
          <div class="col-md-6 mb-3">
            <label class="form-label fw-semibold d-block text-start">
            ...
            <input type="text" class="form-control" value="{{ $server->ip_monitoring ?? 'N/A' }}" disabled>
          </div>
          <div class="col-md-6 mb-3">
            <label class="form-label fw-semibold d-block text-start">
          ...
          <div class="col-md-12 mb-3">
            ...
            <input type="text" class="form-control" value="{{ $server->latest_security_patch ?? 'N/A' }}"
              disabled>
          </div>
          <div class="col-12 mb-3">
            ...
            <textarea class="form-control" rows="2" disabled>{{ $server->other_ips ?? 'N/A' }}</textarea>
          </div>
          <div class="col-12 mb-3">
            <label class="form-label fw-semibold d-block text-start">
