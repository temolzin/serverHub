                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">
                                ...
                                Propietario <span class="text-danger small">(Campo obligatorio)</span>
                            </label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">
                                    ...
                                    Servidor <span class="text-danger small">(Campo obligatorio)</span>
                            </label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">
                                    ...
                                    Nombre <span class="text-danger small">(Campo obligatorio)</span>
                            </label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">
                                    ...
                                    Status <span class="text-danger small">(Campo obligatorio)</span>
                            </label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">
                                ...
                                Tipo <span class="text-danger small">(Campo obligatorio)</span>
                            </label>
                            <select name="type" class="form-select" required>
                                <option value="" disabled>Selecciona un tipo</option>
                                <option value="BD" {{ $application->type == 'BD' ? 'selected' : '' }}>BD</option>
                                <option value="application" {{ $application->type == 'application' ? 'selected' : '' }}>Application</option>
                                <option value="Apliance" {{ $application->type == 'Apliance' ? 'selected' : '' }}>Apliance</option>
                                <option value="Unknown" {{ $application->type == 'Unknown' ? 'selected' : '' }}>Unknown</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="installation_route" class="form-control"
                                placeholder="Ej: /var/www/app" value="{{ $application->installation_route }}">
                        </div>
                            <div class="col-md-6">
                            <label class="form-label fw-semibold">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="comments" class="form-control" rows="2" placeholder="Información adicional">{{ $application->comments }}</textarea>
                        </div>
                    </div>
                </div>
