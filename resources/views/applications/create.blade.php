                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <select name="server_id" class="form-select" required oninvalid="this.setCustomValidity('Selecciona un servidor')" oninput="this.setCustomValidity('')"><option value="" disabled selected>Selecciona un servidor</option>@foreach ($servers as $server)<option value="{{ $server->id }}">{{ $server->hostname_internal }}</option>@endforeach</select>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label"><i class="bx bx-user me-1 text-primary"></i>Propietario</label>
                            <select name="owner_id" class="form-select" required oninvalid="this.setCustomValidity('Selecciona un propietario')" oninput="this.setCustomValidity('')"><option value="" disabled selected>Seleccionar propietario</option>@foreach ($owners as $owner)<option value="{{ $owner->id }}">{{ $owner->name }}</option>@endforeach</select>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label"><i class="bx bx-cloud me-1 text-primary"></i>Maquina GCP</label>
                            <select name="gcp_machine_id" class="form-select" required oninvalid="this.setCustomValidity('Selecciona una máquina')" oninput="this.setCustomValidity('')"><option value="" disabled selected>Seleccionar maquina</option>@foreach ($gcpMachines as $machine)<option value="{{ $machine->id }}">{{ $machine->machine_name }}</option>@endforeach</select>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label"><i class="bx bx-layer me-1 text-primary"></i>Nombre</label>
                        ...
                        <div class="col-md-6 mb-4">
                            <label class="form-label"><i class="bx bx-pulse me-1 text-primary"></i>Status</label>
                            <select name="status" class="form-select" required oninvalid="this.setCustomValidity('Selecciona un estado')" oninput="this.setCustomValidity('')"><option value="" disabled selected>Selecciona un estado</option><option value="production">Producción</option><option value="staging">Staging</option><option value="development">Development</option><option value="inactive">Inactivo</option></select>
                        </div>
                        <div class="col-md-6 mb-4">
                        ...
                        <div class="col-md-6 mb-4">
                            <label class="form-label"><i class="bx bx-chip me-1 text-primary"></i>Memoria asignada (MB)</label>
                        ...
                        <div class="col-md-6 mb-4">
                            <label class="form-label"><i class="bx bx-folder me-1 text-primary"></i>Ruta de instalación</label>
                        ...
                        <div class="col-md-6 mb-4">
                            <label class="form-label"><i class="bx bx-user-check me-1 text-primary"></i>Usuario servicio</label>
                        ...
                        <div class="col-md-12 mb-4">
                            <label class="form-label"><i class="bx bx-calendar me-1 text-primary"></i>Último parche</label>
                        ...
                        <div class="col-12 mb-4">
                            <label class="form-label fw-semibold"><i class="bx bx-cog me-1 text-primary"></i>Procesos</label>
                        ...
                        <div class="col-12 mb-4">
                            <label class="form-label fw-semibold"><i class="bx bx-time-five me-1 text-primary"></i>Tareas programadas</label>
                        ...
                        <div class="col-12 mb-4">
                            <label class="form-label fw-semibold"><i class="bx bx-message-square-detail me-1 text-primary"></i>Comentarios</label>
