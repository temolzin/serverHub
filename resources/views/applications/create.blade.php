                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" name="name" class="form-control"placeholder="Ej: Sistema de Nómina" maxlength="20" required>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" name="type" class="form-control" placeholder="Ej: Web, API, Servicio Windows" maxlength="20">
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label">
                                <i class="bx bx-chip me-1 text-primary"></i>Memoria asignada (MB)
                            </label>
                            <input type="number" name="assigned_memory" class="form-control" placeholder="Ej: 2048" min="1024" max="32768">
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label">
                                <i class="bx bx-folder me-1 text-primary"></i>Ruta de instalación
                            </label>
                            <input type="text" name="installation_route" class="form-control" placeholder="Ej: C:\inetpub\app o /var/www/app" maxlength="100">
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label">
                                <i class="bx bx-user-check me-1 text-primary"></i>Usuario servicio
                            </label>
                            <input type="text" name="user_service" class="form-control" placeholder="Ej: svc_app_prod" maxlength="20">
                        </div>
                       ...
                       <div class="col-12 mb-4">
                            ...
                            <textarea name="processes" class="form-control" rows="2" placeholder="Ej: app.exe, worker.js, java -jar app.jar"></textarea>
                        </div>
                        <div class="col-12 mb-4">
                            <label class="form-label fw-semibold">
                                <i class="bx bx-time-five me-1 text-primary"></i>Tareas programadas
                            </label>
                            <textarea name="cron_jobs" class="form-control" rows="2" placeholder="Ej: 0 2 * * * /usr/bin/php artisan schedule:run"></textarea>
                        </div>
                        <div class="col-12 mb-4">
                            <label class="form-label fw-semibold">
                                <i class="bx bx-message-square-detail me-1 text-primary"></i>Comentarios
                            </label>
                            <textarea name="comments" class="form-control" rows="3" placeholder="Información adicional relevante de la aplicación"></textarea>
                        </div>
                    </div>
                </div>
