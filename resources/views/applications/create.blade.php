                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select name="server_id" id="serverSelect" class="form-select">
                                <option value="" selected>Sin servidor (opcional)</option>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select name="gcp_machine_id" id="gcpMachineSelect" class="form-select">
                                <option value="" selected>Selecciona una maquina (opcional)</option>
                                @foreach ($gcpMachines as $machine)
                                    <option value="{{ $machine->id }}">
                                        {{ $machine->machine_name }} ({{ $machine->internal_ip }})
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label"><i class="bx bx-cube me-1 text-primary"></i>Nombre de la aplicación</label>
                        ...
                        <div class="col-md-6 mb-4"><label class="form-label"><i class="bx bx-pulse me-1 text-primary"></i> Status</label>
                        ...
                        <div class="col-md-6 mb-4">
                            <label class="form-label"><i class="bx bx-shield me-1 text-primary"></i>Último parche</label>
                            <input type="date" name="latest_security_patch" class="form-control">
                        </div>
                        <div class="col-md-6 mb-4"><label class="form-label"><i class="bx bx-user-check me-1 text-primary"></i>Usuario servicio</label>
                            <input type="text" name="user_service" class="form-control" placeholder="Ej: svc_app_prod">
                        </div>
                        <div class="col-md-12 mb-4"><label class="form-label"><i class="bx bx-folder me-1 text-primary"></i>Ruta de instalación</label>
                            <input type="text" name="installation_route" class="form-control" placeholder="Ej: C:\inetpub\app o /var/www/app">
                        </div>
                        <div class="col-md-12 mb-4"><label class="form-label"><i class="bx bx-cog me-1 text-primary"></i>Procesos</label>
                            <textarea name="processes" rows="2" class="form-control" placeholder="Ej: app.exe, worker.js, java -jar app.jar"></textarea>
                        </div>
                        <div class="col-md-12 mb-4"><label class="form-label"><i class="bx bx-time me-1 text-primary"></i>Tareas programadas</label>
                            <textarea name="cron_jobs" rows="2" class="form-control" placeholder="Ej: 0 2 * * * /usr/bin/php artisan schedule:run"></textarea>
                        </div>
                        <div class="col-md-12 mb-4"><label class="form-label"><i class="bx bx-comment me-1 text-primary"></i> Comentarios</label>
                            <textarea name="comments" rows="3" class="form-control" placeholder="Información adicional relevante de la aplicación"></textarea>
                        </div>
                    </div>
                </div>
