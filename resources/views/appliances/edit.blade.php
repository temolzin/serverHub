                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="application_ids[]" class="form-select appliance-searchable-select" multiple>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="dns_name" class="form-control" value="{{ filled($server->dns_name) ? $server->dns_name : 'N/A' }}" maxlength="50">
                        </div>
                        <div class="col-md-6">
