                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="application_ids[]" class="form-select appliance-searchable-select" data-placeholder="Buscar aplicaciones..." multiple>
                                @foreach ($applications as $application)
                                    <option value="{{ $application->id }}"
                                        @selected($server->applications->contains('id', $application->id))>
                                        {{ $application->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            <label class="form-label text-start w-100"><i class="bx bx-radar me-1 text-primary"></i>IP monitoreo</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="environment" class="form-control" value="{{ filled($server->environment) ? $server->environment : 'N/A' }}" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="os_version_internal" class="form-control" value="{{ filled($server->os_version_internal) ? $server->os_version_internal : 'N/A' }}" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-start w-100"><i class="bx bx-server me-1 text-primary"></i>Hostname interno</label>
                            <input type="text" name="hostname_internal" class="form-control" value="{{ filled($server->hostname_internal) ? $server->hostname_internal : 'N/A' }}" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-start w-100"><i class="bx bx-memory-card me-1 text-primary"></i>RAM (MB)</label>
                            <input type="number" name="ram_memory" class="form-control" value="{{ $server->ram_memory ?? 0 }}" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-start w-100"><i class="bx bx-transfer me-1 text-primary"></i>Swap (MB)</label>
                            <input type="number" name="swap_memory" class="form-control" value="{{ $server->swap_memory ?? 0 }}" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="other_ips" rows="2" class="form-control">{{ filled($server->other_ips) ? $server->other_ips : 'N/A' }}</textarea>
                        </div>
                        <div class="col-12">
