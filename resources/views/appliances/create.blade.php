                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="primary_ip_address" class="form-control" placeholder="Ej: 192.168.1.10" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="hostname_internal" class="form-control" placeholder="Ej: apl-prod-01" required>
                        </div>
                        <div class="col-md-6">
