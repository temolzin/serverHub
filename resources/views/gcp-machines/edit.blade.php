                ...
                <div class="modal-body text-start">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" name="internal_ip" class="form-control" placeholder="Ej: 10.0.0.15" value="{{ filled($machine->internal_ip) ? $machine->internal_ip : 'N/A' }}" required>
                        </div>
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <textarea name="other_ips" class="form-control" rows="2"
                            placeholder="Ej: 10.10.10.20, 10.10.10.21">{{ filled($machine->other_ips) ? $machine->other_ips : 'N/A' }}</textarea>
                        </div>
                    </div>
                </div>
