                ...
                <div class="modal-body text-start">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" name="project_name" class="form-control" placeholder="Ej: proyecto-finanzas-prod" maxlength="100" value="{{ $machine->project_name }}" required>
                        </div>
                        <div class="col-md-6 mb-4">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="number" name="swap_memory" class="form-control" placeholder="Ej: 8" value="{{ $machine->swap_memory }}" required>
                        </div>
                        <div class="col-md-12 mb-4">
