    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title d-flex align-items-center gap-2"><i class="bx bx-edit text-primary"></i>Editar máquina GCP</h5>
                ...
                <div class="modal-body text-start">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="bx bx-folder text-primary"></i></span>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="bx bx-globe text-primary"></i></span>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="bx bx-desktop text-primary"></i></span>
                        ...
                        <div class="input-group">
                            <span class="input-group-text"><i class="bx bx-chip text-primary"></i></span>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="bx bx-cog text-primary"></i></span>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="internal_ip" class="form-control ip-check" placeholder="Ej: 10.10.10.15" value="{{ filled($machine->internal_ip) ? $machine->internal_ip : 'N/A' }}" required
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="bx bx-link text-primary"></i></span>
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="bx bx-link-alt text-primary"></i></span>
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="bx bx-data text-primary"></i></span>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"> <i class="bx bx-shield-quarter text-primary"></i></span>
                        ...
                        <div class="col-md-3 mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="bx bx-memory-card text-primary"></i></span>
                        ...
                        <div class="col-md-3 mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="bx bx-transfer text-primary"></i></span>
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="bx bx-list-ul text-primary"></i></span>
