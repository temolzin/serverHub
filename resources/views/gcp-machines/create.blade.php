                ...
                <div class="modal-body text-start">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" name="project_name" class="form-control" placeholder="Ej: proyecto-finanzas-prod" pattern="[A-Za-z0-9\-]+"  maxlength="30" required>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" name="machine_name" class="form-control" placeholder="Ej: vm-app-prod-01" pattern="[A-Za-z0-9\-]+" maxlength="35" required>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label">
                                <i class="bx bx-chip me-1 text-primary"></i>Nombre interno (obligatorio)
                            </label>
                            <input type="text" name="machine_internal_name" class="form-control" placeholder="Ej: app-internal-01" maxlength="35" required>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label">
