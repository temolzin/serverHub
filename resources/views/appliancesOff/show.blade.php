<div class="modal fade text-start" id="showApplianceOffModal{{ $server->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title d-flex align-items-center gap-2"><i class="bx bx-chip text-primary fs-4"></i>Detalle del apliance apagado</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold d-block text-start"><i class="bx bx-user me-1 text-primary"></i>Propietario</label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold d-block text-start"><i class="bx bx-desktop me-1 text-primary"></i>VM (VMware)</label>
                    ...
                    <div class="col-md-6 mb-3 text-start">
                        ...
                        <input type="text" class="form-control" value="{{ $server->creator->name ?? 'N/A' }} {{ $server->creator->last_name ?? '' }}" disabled>
                    </div>
                    <div class="col-md-6 mb-3 text-start">
                        <label class="form-label fw-semibold"><i class="bx bx-calendar-plus me-1 text-primary"></i>Fecha de creación</label>
