            ...
            <a class="nav-link dropdown-toggle hide-arrow p-0"
               ...
               aria-expanded="false">
                <div class="avatar avatar-online">
                    <img src="{{ Auth::user()->avatar ? asset(Auth::user()->avatar) : asset('assets/img/avatars/1.png') }}" class="w-px-40 h-auto rounded-circle" style="object-fit: cover;">
                </div>
            </a>
                    ...
                    <a class="dropdown-item" href="javascript:void(0);">
                        <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar avatar-online">
                                    <img
                                        src="{{ Auth::user()->avatar ? asset(Auth::user()->avatar) : asset('assets/img/avatars/1.png') }}" class="w-px-40 h-auto rounded-circle" style="object-fit: cover;">
                                </div>
                            </div>
