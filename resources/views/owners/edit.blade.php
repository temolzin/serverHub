                ...
                <div class="modal-body">
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input type="text" name="name" class="form-control" placeholder="Ej: Carlos" maxlength="20" value="{{ $owner->name }}" pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+"  required>
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input type="text" name="last_name" class="form-control" placeholder="Ej: Ramírez" maxlength="50" value="{{ $owner->last_name }}" pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+"  required>
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input type="text" name="number_phone" class="form-control" placeholder="Ej: 5512345678" maxlength="10" pattern="[0-9]{10}" inputmode="numeric" oninput="this.value=this.value.replace(/[^0-9]/g,'')" value="{{ $owner->number_phone }}" required>                        </div>
