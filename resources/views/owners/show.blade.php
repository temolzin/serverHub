        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title d-flex align-items-center gap-2">
                    <i class="bx bx-user-circle text-primary fs-4"></i>Detalle del propietario
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" value="{{ $owner->created_at ? $owner->created_at->format('d/m/Y h:i A') : 'N/A' }}" disabled>
                </div>
                <div class="mb-3">
                    <label class="form-label fw-semibold">
