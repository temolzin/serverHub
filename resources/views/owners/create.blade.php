            ...
            <form action="{{ route('owners.store') }}" method="POST"
                ...
                <div class="modal-body">
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Ej: Juan" maxlength="20" pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="last_name" class="form-control" placeholder="Ej: Pérez" maxlength="50" pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+" required>                        <small class="text-muted">Máximo 50 caracteres</small>
                    </div>
                    <div class="mb-4">
                        <label class="form-label fw-semibold">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="number_phone" class="form-control" placeholder="Ej: 5512345678" pattern="[0-9]{10}" inputmode="numeric" oninput="this.value=this.value.replace(/[^0-9]/g,'')" maxlength="10"inputmode="numeric" required>
