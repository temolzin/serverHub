    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title d-flex align-items-center gap-2"><i class="bx bx-data text-primary fs-4"></i> Detalle de la base de datos</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ filled($databaseServerNames) ? $databaseServerNames : 'N/A' }}" disabled>
                    </div>
                        <div class="col-md-6">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold"><i class="bx bx-calendar me-1 text-primary"></i>Última actualización</label>
