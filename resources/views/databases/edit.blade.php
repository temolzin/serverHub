            ...
            <form action="{{ route('databases.update', $database) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-4">
                        ...
                        <option value="" disabled>Seleccione el motor de BD</option>
                        <option value="oracle" {{ $database->type == 'oracle' ? 'selected' : '' }}>Oracle</option>
                        <option value="msssql" {{ $database->type == 'msssql' ? 'selected' : '' }}>MSSQL</option>
                    ...
                    <div class="mb-4">
                        ...
                        value="{{ $database->last_update ? \Carbon\Carbon::parse($database->last_update)->format('Y-m-d') : '' }}">
                    </div>
                    <div class="mb-4">
                        <label class="form-label">
