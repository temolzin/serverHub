@forelse ($databases as $database)
    <tr>
        ...
        <td class="text-end">
            <div class="dropdown">
                ...
                <a class="dropdown-item text-danger" data-bs-toggle="modal" data-bs-target="#deleteDatabaseModal{{ $database->id }}">
    ...
    @empty
    <tr>
        <td colspan="6" class="text-center text-muted">No se encontraron bases de datos</td>
    </tr>
@endforelse
