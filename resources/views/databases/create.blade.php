        ...
        <div class="modal-content">
            ...
            <form action="{{ route('databases.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-4">
                        <label class="form-label">Propietario **(campo obligatorio)**</label>
                    ...
                    <div class="mb-4">
                        <label class="form-label">Nombre **(campo obligatorio)**</label>
                        <input type="text" name="name" class="form-control" placeholder="Ej: db_produccion" required>
                    </div>
                    <div class="mb-4">
                        <label class="form-label">Tipo **(campo obligatorio)**</label>
                        <select name="type" class="form-select" required>
                            <option value="" disabled selected>Selecciona el motor de BD</option>
                            <option value="oracle">Oracle</option>
                            <option value="msssql">MSSQL</option>
                    ...
                    <div class="mb-4">
                        <label class="form-label">Estado **(campo obligatorio)**</label>
