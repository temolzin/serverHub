    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('databases.store') }}" method="POST">
                ...
                <div class="mb-4">
                    <label class="form-label">Comentarios</label><textarea name="comments" class="form-control" rows="3" maxlength="500"placeholder="Información adicional relevante"></textarea>
                </div>
                </div>
