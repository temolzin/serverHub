          ...
          <div class="mb-4">
            ...
            <div class="input-group input-group-merge">
              ...
              <select name="state" class="form-control">
                <option value="1" {{ $server->state ? 'selected' : '' }}>Activo</option>
                <option value="0" {{ !$server->state ? 'selected' : '' }}>Inactivo</option>
              </select>
            </div>
          </div>
          <div class="mb-4">
          ...
          <div class="mb-4">
            ...
            <div class="input-group input-group-merge">
              ...
              <input type="text" name="primary_ip_address" class="form-control ip-check"
                value="{{ $server->primary_ip_address }}" required data-exclude="{{ $server->id }}"
                data-error-target="edit-server-ip-error-{{ $server->id }}">
            </div>
          </div>
          <div id="edit-server-ip-error-{{ $server->id }}" class="text-danger text-center mb-2 d-none"></div>
          <div class="mb-4">
