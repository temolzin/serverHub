                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="vm_according_to_the_vmware" class="form-control text-start" value="{{ old('vm_according_to_the_vmware', $server->vm_according_to_the_vmware) }}" maxlength="100" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-start w-100"><i class="bx bx-network-chart me-1 text-primary"></i> IP primaria</label>
                            <input type="text" name="primary_ip_address" class="form-control text-start" value="{{ old('primary_ip_address', $server->primary_ip_address) }}" pattern="(\d{1,3}\.){3}\d{1,3}|[Nn]/[Aa]" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="ip_user" class="form-control text-start" value="{{ old('ip_user', $server->ip_user) }}" pattern="(\d{1,3}\.){3}\d{1,3}|[Nn]/[Aa]">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-start w-100"><i class="bx bx-line-chart me-1 text-primary"></i>IP monitoreo</label>
                            <input type="text" name="ip_monitoring" class="form-control text-start" value="{{ old('ip_monitoring', $server->ip_monitoring) }}" pattern="(\d{1,3}\.){3}\d{1,3}|[Nn]/[Aa]">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="other_ips" rows="2" class="form-control text-start">{{ old('other_ips', $server->other_ips) }}</textarea>
                        </div>
                        <div class="col-12">
